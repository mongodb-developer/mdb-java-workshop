...
public class ConnectionHelper {
    ...
    public ConnectionHelper(String mongoUri, byte[] masterKey) {
        ConnectionString CONNECTION_STR= new ConnectionString(mongoUri);
        ConsoleDecoration.printSection("INITIALIZATION");
        this.kmsProviders = generateKmsProviders(masterKey);
        this.encryption = createEncryptionClient(CONNECTION_STR);
        this.client = createMongoClient( CONNECTION_STR);
    }

    private MongoClient createMongoClient(ConnectionString CONNECTION_STR) {
    ...
    private ClientEncryption createEncryptionClient(ConnectionString CONNECTION_STR) {
